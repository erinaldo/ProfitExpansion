    ...
    public partial class FrmUsuarios : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void FrmUsuarios_Load(object sender, EventArgs e)
        {
            using (var context = new Profit_RGEntities())
            {
                ...
                List<Usuario> Li = context.Usuarios.ToList();
                foreach (var item in Li)
                {
                    buscar1.Add(item.nombre.Trim());
                }
        ...
        private void Buscar()
        {
            try
            {
                ...
                {
                    pSeleccionarUsuariosN_Result Usuario1 = new pSeleccionarUsuariosN_Result();
                    
                    var user1 = context.Usuarios.Where(xD => xD.nombre == txtBuscar.Text.Trim()).ToList();

                    if (user1.Count > 0)
                    {
                        Usuario1 = context.pSeleccionarUsuariosN(user1[0].nombre.Trim().ToUpper()).FirstOrDefault();
                        txtCo_usuario.Text = Usuario1.co_usuario.Trim();
                        cbo_profit.Text = Usuario1.co_profit.Trim();
                        txtNombre.Text = Usuario1.nombre.Trim();
                        txtClave.Text = Usuario1.clave.ToString();
                        txtClaveR.Text = Usuario1.clave.ToString();
                        cboNivel.SelectedValue = Usuario1.tipo;
                        txtRdv.Text = Usuario1.co_rdv;
                        cbo_department.Text = Usuario1.Departamento;
                        chkP_emp.CheckState = Usuario1.p_emp == -1 ? CheckState.Unchecked : Usuario1.p_emp == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_nav.CheckState = Usuario1.p_nav == -1 ? CheckState.Unchecked : Usuario1.p_nav == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_usu.CheckState = Usuario1.p_usu == -1 ? CheckState.Unchecked : Usuario1.p_usu == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_con.CheckState = Usuario1.p_con == -1 ? CheckState.Unchecked : Usuario1.p_con == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_emp.CheckState = Usuario1.p_emp == -1 ? CheckState.Unchecked : Usuario1.p_emp == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_mco.CheckState = Usuario1.p_mco == -1 ? CheckState.Unchecked : Usuario1.p_mco == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_pst.CheckState = Usuario1.p_pst == -1 ? CheckState.Unchecked : Usuario1.p_pst == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_art.CheckState = Usuario1.p_art == -1 ? CheckState.Unchecked : Usuario1.p_art == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        ChkP_clave.CheckState = Usuario1.p_clave == -1 ? CheckState.Unchecked : Usuario1.p_clave == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_malm.CheckState = Usuario1.p_malm == -1 ? CheckState.Unchecked : Usuario1.p_malm == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_ord.CheckState = Usuario1.p_ord == -1 ? CheckState.Unchecked : Usuario1.p_ord == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_pped.CheckState = Usuario1.p_pped == -1 ? CheckState.Unchecked : Usuario1.p_pped == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_cxc.CheckState = Usuario1.p_cxc == -1 ? CheckState.Unchecked : Usuario1.p_cxc == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_RegRep.CheckState = Usuario1.p_regrep == -1 ? CheckState.Unchecked : Usuario1.p_regrep == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_EnvRep.CheckState = Usuario1.p_envrep == -1 ? CheckState.Unchecked : Usuario1.p_envrep == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_Rep.CheckState = Usuario1.p_rep == -1 ? CheckState.Unchecked : Usuario1.p_rep == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        ChkP_lcre.CheckState = Usuario1.p_lcre == -1 ? CheckState.Unchecked : Usuario1.p_lcre == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_com.CheckState = Usuario1.p_com == -1 ? CheckState.Unchecked : Usuario1.p_com == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_metas.CheckState = Usuario1.p_metas == -1 ? CheckState.Unchecked : Usuario1.p_metas == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_ubi.CheckState = Usuario1.p_ubi == -1 ? CheckState.Unchecked : Usuario1.p_ubi == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_consu.CheckState = Usuario1.p_cons == -1 ? CheckState.Unchecked : Usuario1.p_cons == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_camp_L.CheckState = Usuario1.p_camp_L == -1 ? CheckState.Unchecked : Usuario1.p_camp_L == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_acti.CheckState = Usuario1.p_acti == -1 ? CheckState.Unchecked : Usuario1.p_acti == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_consum.CheckState = Usuario1.p_consu == -1 ? CheckState.Unchecked : Usuario1.p_consu == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkP_caso.CheckState = Usuario1.p_caso == -1 ? CheckState.Unchecked : Usuario1.p_caso == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chkJcontrol.CheckState = Usuario1.p_control == -1 ? CheckState.Unchecked : Usuario1.p_control == 0 ? CheckState.Indeterminate : CheckState.Checked;
                        chksupervi.CheckState = Usuario1.p_supervi == -1 ? CheckState.Unchecked : Usuario1.p_supervi == 0 ? CheckState.Indeterminate : CheckState.Checked;

                        //var Imagen = ImagenBD.BytesToImage(Usuario.ilustracion);

                        Validador = Usuario1.validador;
                        CargarDetalle();
                        ...
                        else
                        {
                            if (Nuevo == true)
                            {
                                context.pInsertarUsuario(txtCo_usuario.Text.Trim(), txtNombre.Text.Trim(), cboNivel.SelectedIndex,
                                                        ...
                                                        P_regrep, P_envrep, P_rep,P_lcre, P_com, P_metas,P_ubi,P_cons,P_camp_L,P_acti, P_cons,P_caso,cbo_profit.SelectedValue.ToString (),P_control,P_supervi,cbo_department.SelectedIndex.ToString());
                            }
                            else
                            {
