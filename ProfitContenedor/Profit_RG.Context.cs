...
namespace ProfitContenedor
{
    ...
    public partial class Profit_RGEntities : DbContext
    {
        ...
        public virtual int pInsertarReng_emb(string empresa, Nullable<int> nro_viaje, Nullable<int> fact_num, string co_art, string art_des, Nullable<decimal> total_art, Nullable<decimal> prec_vta, Nullable<decimal> tasa, string prov, string uni_venta)
        {
            var empresaParameter = empresa != null ?
                new ObjectParameter("empresa", empresa) :
                new ObjectParameter("empresa", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pInsertarReng_emb", empresaParameter, nro_viajeParameter, fact_numParameter, co_artParameter, art_desParameter, total_artParameter, prec_vtaParameter, tasaParameter, provParameter, uni_ventaParameter);
        }
        ...
        public virtual int pNotificacionEmailEmbarque(string iDViaje)
        {
            var iDViajeParameter = iDViaje != null ?
                new ObjectParameter("IDViaje", iDViaje) :
                new ObjectParameter("IDViaje", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pNotificacionEmailEmbarque", iDViajeParameter);
        }
    }
}
